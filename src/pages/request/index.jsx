      ...
      if (response.statusCode >= 200 && response.statusCode < 300) {
        ...
        setTimeout(() => {
          ...
          if (!resourceId && type === 'service-request') {
            ...
            Taro.redirectTo({ url: '/pages/orders/orderConfirmation' });
          } else {
                ...
                <View className='date-input-row'>
                  <View className='date-input'>
                    ...
                    <Picker
                      ...
                      disabled={isSubmitting}
                      style={{position:'absolute',right:0,top:0,bottom:0,width:'2em',zIndex:2,background:'transparent',opacity:0}}
                    >
                      <View
                        className='date-picker-icon'
